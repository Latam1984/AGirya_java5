package modul_9.Homework;

import java.util.*;
import java.util.function.Predicate;
import java.util.stream.Collectors;

import static modul_9.Homework.Currency.EUR;
import static modul_9.Homework.Currency.USD;
 ...
 * Создайте класс Mains и протестируйте каждый метод на тестовых данных.
 */
public class Main {
